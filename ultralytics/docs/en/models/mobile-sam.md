---
comments: true
description: Discover MobileSAM, a lightweight and fast image segmentation model for mobile applications. comparisons its performance with the original SAM and explore its various modes.
